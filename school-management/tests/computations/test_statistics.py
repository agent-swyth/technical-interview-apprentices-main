...
def test_compute_student_topic_grades_mean(group_all_passing: Group):
    ## Use grades property in group_all_passing fixture
    grades:Grade = group_all_passing.grades

    assert compute_student_topic_grades_mean(group_all_passing.grades, 2, 1) == 16.0

# Raise exception when number_grades equals to 0
